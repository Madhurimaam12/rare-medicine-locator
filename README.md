...
Notifications are currently email-only. SMS alerts will be added by integrating Twilio.

## 12. Future Enhancements

Payment Gateway Integration is a high priority enhancement that will enable online payments through Razorpay or Stripe.

Prescription Upload is a high priority enhancement that will allow patients to upload prescription images.

Live Chat is a medium priority enhancement that will enable real-time messaging between patients and pharmacies.

Mobile Application is a medium priority enhancement that will develop a React Native mobile application.

SMS Notifications is a low priority enhancement that will send order updates via SMS using Twilio.

Medicine Image Gallery is a low priority enhancement that will allow uploading and displaying multiple medicine images.

Pharmacy Ratings is a low priority enhancement that will display average rating for each pharmacy.

Order Analytics Dashboard is a low priority enhancement that will provide advanced analytics with more chart types.
